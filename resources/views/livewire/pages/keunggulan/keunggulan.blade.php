    ...
    <div class="card p-3">
        <ul class="nav nav-tabs" id="myTab" role="tablist" >
            <li class="nav-item" role="presentation" wire:ignore.self>
                <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" wire:ignore.self
                    role="tab" aria-controls="home" aria-selected="true">
                    <i class='bx bxs-like'></i>
                    Keunggulan</button>
            </li>
            <li class="nav-item" role="presentation" wire:ignore.self>
                <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" wire:ignore.self
                    role="tab" aria-controls="profile" aria-selected="false">
                    <i class='bx bx-windows'></i>
                    Indonesian usage</button>
            </li>
        </ul>
        <div class="tab-content" id="myTabContent" wire:ignore.self>
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab" wire:ignore.self>
                <div x-data="{ detail: true, edit: false }" x-init="
                $wire.on('showdetail', (event) => {
                    ...
                    <div x-show="edit" x-transition>
                        <form wire:submit='save'>
                            ...
                            <div class="d-flex justify-content-between">
                                <button @click="edit = false;detail=true" type="button" class="btn btn-warning">
                                    <i class='bx bx-x'></i>
                                    Cancel</button>
            ...
            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab" wire:ignore.self >
                <div x-data="{ details: true, edits: false }"  x-init="
                $wire.on('showdetailKeunggulan', (event) => {

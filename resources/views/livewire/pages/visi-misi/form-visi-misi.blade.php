            ...
            <div class="row mb-3">
                <div class="col">
                    <x-componen-form.input-image-dropify label='Detail Visi-Misi Image' wireModel="imageVisi"
                        ...
                        @error('imageVisi') is-invalid @enderror
                        @endslot
            ...
            <div class="row mb-3">
                <div class="col">
                    <x-componen-form.input-image-dropify label='Visi Image' wireModel="imageMisi"
                        ...
                        @slot('classInputValidate')
                        @error('imageMisi') is-invalid @enderror
                        @endslot
                    </x-componen-form.input-image-dropify>
                </div>
                <div class="col">
                    <x-componen-form.input-image-dropify label='Misi Images' wireModel="image" imageDefault="{{$image}}"
                        name="image">
                        @slot('classInputValidate')

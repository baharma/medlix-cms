                    ...
                    <div class="d-lg-block" id="kt_header_nav_wrapper">
                        <div class="d-lg-block p-5 p-lg-0" data-kt-drawer="true" data-kt-drawer-name="landing-menu"
                            ...
                            <div class="menu menu-column flex-nowrap menu-rounded menu-lg-row menu-title-gray-600 menu-state-title-primary nav nav-flush fs-5 fw-semibold"
                                ...
                                <div class="menu-item">
                                    <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#keunggulan"
                                        data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">Keunggulan</a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link nav-link py-3 px-4 px-xxl-6 {{ $page == 'news-update' ? 'active' : '' }}"
                                        href="#news" data-kt-scroll-toggle="true" data-kt-drawer-dismiss="true">News &
                                        Update</a>
                                </div>
                                <div class="menu-item">
                                ...
                                <div class="menu-item">
                                    <a class="menu-link nav-link py-3 px-4 px-xxl-6" href="#event"

<div>
    <!-- Modal -->
    <div class="modal fade" wire:ignore.self id="ListKeunggulan" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                ...
                <form wire:submit.prevent='save'>
                    <div class="modal-body">
                        <div>
                            ...
                            <div class="row mb-3">
                                <x-componen-form.textarea-input label="Title keunggulan" idTextarea="DescriptionEvent"
                                    wireModel="title" rows="3" classInput="col-sm-9" classLabels="col-sm-3"
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-warning closeBtn" data-bs-dismiss="modal"
                            id="close-modal"><i class="bx bx-x"></i> Close</button>
